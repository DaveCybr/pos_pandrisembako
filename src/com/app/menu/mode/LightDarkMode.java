...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("com/app/menu/mode/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("com/app/menu/mode/dark.svg"));
